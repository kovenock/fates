...
module FatesAllometryMod
  ...
  real, parameter, public :: sla_max_drymass = 0.02385_r8 ! Half max sla (m2/g dry mass) obs for all plants (Kattge et al. 2011) 
  !real, parameter, public :: sla_max_drymass = 0.006_r8 ! Testing sla_max=slatop (will double below to get (m2/gC)) 
